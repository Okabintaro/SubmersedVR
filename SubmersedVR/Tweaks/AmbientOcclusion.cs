...
namespace SubmersedVR
{
    ...
    static class AmbientOcclusionVR
    {
        ...
        public static void AddOcclusionEffect(Camera camera)
        {
            ...
            /*
            effect = camera.gameObject.GetComponent<AmplifyOcclusionEffect>();
            effect.SampleCount = AmplifyOcclusion.SampleCountLevel.Medium;
            effect.ApplyMethod = AmplifyOcclusionEffect.ApplicationMethod.Deferred;
            effect.FilterEnabled = Settings.AmbientOcclusionTemporalFilterEnabled;
            effect.enabled = Settings.UseAmbientOcclusion;
            */
        }
